...
const Home = () => {
  ...
  const handleClick = () => {
    ...
    // ✅ Redirect to login with email param
  ...
  return (
    ...
    <section className="banner-section">
      <div className="auto-container">
        <div className="row">
          <div className="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column wow fadeInUp animated" data-wow-delay="1000ms"tyle={{visibility:"visible",animationName:"fadeInUp"}}>
              <div className="title-box mb-3">
                <h5>Welcome to The Code helper</h5>
                <h3>Expand your professional team <span>effortlessly with skilled</span> freelancers.</h3>
              </div>
              <Link to={user && user.role == 'Client' ? '/user/project/create' : '/project/create'} type="button" className="button-87 px-5 py-3 mb-4 ms-0"
              >Submit Your Project</Link>
              <div className="popular-searches">
                <span className="title">Popular Searches : </span>
                <Link to="/projects?text=Website Development">Website Development</Link>,
                <Link to="/projects?text=Logo Design">Logo Design</Link>,
                <Link to="/projects?text=SEO">SEO</Link>,
                <Link to="/projects?text=Social Media Marketing">Social Media Marketing</Link>,
          ...
          <div className="image-column col-lg-6 col-md-12">
            <div className="image-box">
              <figure className="main-image wow fadeIn animated" data-wow-delay="500ms" style={{visibility:"visible",animationName:"fadeInUp"}}>
      ...
      <section className="layout-pt-60 pt-5 layout-pb-60 pb-5 border-bottom-none services-main">
        <div className="auto-container">
           <div className="d-flex align-items-center justify-content-between wow fadeInUp animated" style={{visibility:"visible",animationName:"fadeInUp"}}>
              <div className="sec-title">
			          <h6 className="blue-clr text-uppercase">Our Services</h6>
                <h2>Experts Developers Available for Hire</h2>
              </div>
           </div>
              ...
              <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
                <div className="inner-box">
                  <div className="content">
                    ...
                    <h4><a href="#">Web Development (Frontend & Backend)</a></h4>
                  </div>
                </div>
              </div>
              <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
            <div className="inner-box active">
              <div className="content">
               <i className="bi bi-filetype-css"></i>
                <h4><a href="#">DevOps & Cloud Setup</a></h4>
              </div>
            </div>
          </div>
          <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
            <div className="inner-box">
              <div className="content">
                ...
                <h4><a href="#">Database & API Development</a></h4>
              </div>
            </div>
          </div>          
          <div className="category-block-two at-home21  col-lg-3 col-md-4 col-6">
            <div className="inner-box">
              <div className="content">
                ...
                <h4><a href="#">Automation & Scripting</a></h4>
              </div>
            </div>
          </div>
          <div className="category-block-two at-home21  col-lg-3 col-md-4 col-6">
            <div className="inner-box">
              <div className="content">
                ...
                <h4><a href="#">IT Support & Systems Administration</a></h4>
              </div>
            </div>
          </div>
          <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
            <div className="inner-box">
              <div className="content">
                ...
                <h4><a href="#">Data Analysis & Business Intelligence</a></h4>
              </div>
            </div>
          </div>
          <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
            <div className="inner-box">
              <div className="content">
                <svg className="str" width="70px" height="70px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M6 2.5H7M4.5 4V1.5C4.5 0.947715 4.94772 0.5 5.5 0.5H9.5C10.0523 0.5 10.5 0.947715 10.5 1.5V6.5C10.5 7.05228 10.0523 7.5 9.5 7.5H5.5C4.94772 7.5 4.5 7.94772 4.5 8.5V13.5C4.5 14.0523 4.94772 14.5 5.5 14.5H9.5C10.0523 14.5 10.5 14.0523 10.5 13.5V11M8 4.5H1.5C0.947715 4.5 0.5 4.94772 0.5 5.5V10.5C0.5 11.0523 0.947715 11.5 1.5 11.5H4.5M7 10.5H13.5C14.0523 10.5 14.5 10.0523 14.5 9.5V4.5C14.5 3.94772 14.0523 3.5 13.5 3.5H10.5M8 12.5H9"/>
                ...
                <h4><a href="#">AI & Chatbot Integration</a></h4>
              </div>
            </div>
          </div>
          <div className="category-block-two at-home21 col-lg-3 col-md-4 col-6">
      ...
      <section className="who bg-body-tertiary py-5">
            ...
            <div className="col-md-6">
              ...
              <img src={img1} class="img-fluid mb-4" />
              <p>Unveil the essence of The Code Helper: a community-driven platform dedicated to empowering coders of all levels. Discover who we are and how we're shaping the future of coding education.</p>
            ...
            <div className="col-md-6 px-md-5">
					<div className="who-box">
						...
						<p className="mb-0">Scale your workforce up or down based on project needs.</p>
					</div>
					<div className="who-box">
						<i className="bi bi-check"></i>
						<h4>Access to Global Expertise</h4>
						<p className="mb-0">Connect with top freelancers worldwide for specialized skills.</p>
					</div>
					<div className="who-box">
						<i className="bi bi-check"></i>
						<h4>Enhanced Productivity</h4>
						<p className="mb-0">Focus on core business operations while freelancers handle the rest.</p>
					</div>
					<div className="who-box">
						<i className="bi bi-check"></i>
						<h4>Quality Assurance</h4>
						<p className="mb-0">Work with vetted professionals who deliver high-quality results.</p>
					</div>
					<div className="who-box">
						<i className="bi bi-check"></i>
						<h4>Innovative Solutions</h4>
						<p className="mb-0">Gain fresh perspectives and creative approaches to business challenges.</p>
					</div>
          <Link to="/register?type=Client" className="button-87 d-inline-block mt-3" href=""><span className="btn-title">Signup for a Client</span></Link>
				</div>
      ...
      <section className="why py-5  wow fadeInUp animated" data-wow-delay="1000ms" style={{visibility: "visible", animationDelay: "1000ms", animationName: "fadeInUp"}}>
	<div className="container my-5">
		<div className="row">
			...
			<div className="col-md-4">
				<div className="why-box text-center">
					<img src={img2} className="img-fluid mb-3" alt="" />
					<h4>Fast & Easy Hiring</h4>
					<p>Post your project and receive proposals from talented freelancers, making the hiring process swift and efficient.</p>
				</div>
			</div>
			<div className="col-md-4">
				<div className="why-box active text-center">
					<img src={img3} className="img-fluid mb-3" alt="" />
					<h4>Expert Freelancers</h4>
					<p>Access a global talent pool of expert freelancers skilled in various programming languages and technologies.</p>
				</div>
			</div>
			<div className="col-md-4">
				<div className="why-box text-center">
					<img src={img4} className="img-fluid mb-3" alt="" style={{height:"182px"}} />
					<h4>Quality Code Solutions</h4>
					<p>Receive high-quality code solutions tailored to your project requirements, with options for revisions and feedback.</p>
				</div>
			</div>
		</div>
	</div>
...
<div className="container-fluid bg-body-tertiary py-5 wow fadeInUp animated" data-wow-delay="1000ms" style={{visibility: "visible", animationDelay: "1000ms", animationName: "fadeInUp"}}>
...
<section className="subscribe-section at-home22 py-xl-0">
      <div className="auto-container py-5">
        <div className="outer-box d-flex wow fadeInUp animated" style={{visibility: "visible", animationDelay: "1000ms", animationName: "fadeInUp"}}>
          <div className="sec-title">
            <h3 className="text-white">Join. Work. Thrive – Your Freelance Journey Starts Here!</h3>
            <div className="text-white">Unlock endless opportunities as a freelancer. Sign up today and start working on your own terms!</div>
          </div>
